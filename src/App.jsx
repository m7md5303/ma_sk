...
function App() {
  ...
  <h1 className='ked'>من 8 رمضان الى 7 شوال</h1>
   ...
   <ul>
   <li>سعر الفرد 69900 جنيه مصري</li>
  ...
  <h1 className='ked'>من 8 رمضان الى 7 شوال</h1>
   ...
   <ul>
   <li>سعر الفرد 65000 جنيه مصري</li>
  ...
  <h1 className='ked'>من 5 رمضان الى 17 رمضان</h1>
   ...
   <ul>
   <li>سعر الفرد 45000 جنيه مصري</li>
  ...
  <h1 className='ked'>من 5 رمضان الى 17 رمضان</h1>
   ...
   <ul>
   <li>سعر الفرد 42000 جنيه مصري</li>
...
{/* 
   ...
   <img src={eqt}alt='Loading⏳' className='im'/>:null} {showomra? 
     ...
     <h1>الأسعار تشمل</h1>
      <div className='print'>
        <ul>
          <li> المزارات داخل المملكةالعربية السعودية و الروضة الشريفة</li>
     ...
     <h1>ملاحظات بالنسبة للبرامج </h1>
      <div className='printb'>
        <ul>
          ...
          <li>خصم خاص لخاملي تأشيرات الزيارة الشخصية أو العائلية</li>
