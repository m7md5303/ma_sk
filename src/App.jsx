     ...
     <h1>الأسعار بالنسبة للبرامج فوق الاقتصادية تشمل</h1>
      <div className='print'>
        <ul>
          ...
          <li>الانتقالات  بأتوبيسات حديثة مكيفة موديل ٢٠٢٢-٢٠٢٣ </li>
...
<img src={fpr}/></div>
     ...
     <h1>ملاحظات بالنسبة للبرامج فوق الاقتصادية</h1>
      <div className='printb'>
        <ul>
          <li>تم حساب الأسعار علي أساس سعر الريال مقدراب13.5 جنيه مصري </li>
          <li>وأية زيادة تطرأ يتم علي اثرها تغيير الأسعار </li>
